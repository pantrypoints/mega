...
async function seed() {
  ...
  const users = [
    ...
    {id: nanoid(), username: "anh", codename: "anh", pin: hash("444444"), passwordHash: hash("123123"), avatar: "/anh.jpg", gender: "female", dateOfBirth: "1990-11-23", email: "carla@example.com", phone: "+1029384756", city: "Manila", country: "Philippines" }
  ];
  ...
  const productsToInsert = [
    {name: "Organic Honey", measure: "liter", points: 20.0, category: "Food", photo1: "/honey.jpg", 
        photo2: "/honey2.jpg", description: "Pure, local, and organic honey from the mountains.", headline: "The Sweetest Deal!", userId: users[5].id },
    {name: "Tomatoes", measure: "kilo", points: 2, category: "Food", photo1: "/tomatoes.jpg", description: "Home grown tomatoes.", headline: "Fresh and Healthy!", userId: users[4].id }
  ];
