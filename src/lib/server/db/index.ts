...
// error in cloudfalre: import { dev } from '$app/environment';
// import { drizzle } from 'drizzle-orm/libsql';
// import { createClient } from '@libsql/client';
// import * as schema from './schema';
// import { env } from '$env/dynamic/private';
...
// 	// In Cloudflare, if secrets are not set, platformEnv will be undefined, falling back to $env.
// 	// We rely on Cloudflare's binding configuration to populate these variables.
// 	if (!dev && !DATABASE_AUTH_TOKEN) throw new Error('DATABASE_AUTH_TOKEN is not set');
...
// 	// This function now exclusively returns the Drizzle client instance.
// 	return drizzle(client, { schema });
// }
