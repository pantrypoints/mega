...
const handleAuth: Handle = async ({ event, resolve }) => {
  ...
  if (sessionToken) {
    // Pass the db instance from event.locals to validateSessionToken
  ...
  // ⛔ Redirect to login if not authenticated 🟢 but allow access to public pages We do not include '/' here, as we handle it separately below.
