<script lang='ts'>
    ...
    import { MessageCircle, LogOut, ChartNoAxesCombined, CircleQuestionMark, Megaphone, Shirt, Utensils, Users, User, Tally5 } from 'lucide-svelte';
...
<div class="min-h-screen bg-sky-50 flex items-center justify-center p-4">
    <div class="w-full max-w-lg bg-white p-8 sm:p-10 rounded-3xl shadow-2xl border-t-4 border-sky-500 transform transition duration-500 hover:shadow-3xl">
        ...
        <div class="grid grid-cols-3 gap-4 mt-8">
            ...
            >
                <div class="text-3xl p-4 mb-1">
                    <MessageCircle   class="w-16 h-16 text-gray-500" />
                </div>
                <div class="text-gray-800 font-semibold text-sm">
                    {m.points()}
                </div>
