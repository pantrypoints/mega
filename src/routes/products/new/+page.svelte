    ...
    <div class="w-full max-w-3xl bg-white dark:bg-slate-900 p-8 sm:p-10 rounded-3xl shadow-2xl border-t-4 border-sky-500 dark:border-sky-600 transition-colors">
        ...
        <form method="POST" use:enhance class="space-y-8">
            ...
            <div class="flex gap-4 pt-6">
                ...
                <a
                    href="/products"
                    class="flex-1 bg-gray-200 dark:bg-slate-700 hover:bg-gray-300 dark:hover:bg-slate-600 text-gray-700 dark:text-slate-200 font-bold py-3 rounded-xl shadow-lg text-center transition duration-300 flex items-center justify-center"
                >
                    {m.cancel()}
                </a>
            </div>
